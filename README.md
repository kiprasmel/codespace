...
codespace stack ls [-g|--global] [-i|--integrated] [-S|--size]
...
sub-commands:
  ...
  ls [-g|--global] [-i|--integrated] [-S|--size] [--older-than <duration>]
     [--by-commit-age] [--rm] [-q|--quiet]
                  ...
                  filters:
                    -i, --integrated      keep only fully-integrated stacks. a
                                          ...
                                          when gh is unavailable; CS_NO_GH=1
                                          forces the local-only path.
